...
beforeEach(function () {
    $this->dummyWebhookCall = WebhookCall::create([
        ...
        'payload' => [
            'email' => 'test@test.at',
            'name' => 'Test User',
            'p_product_id' => 'pro_01hjxx11s2hnq8py4d2a5pmr6m',
        ],
    ]);
});
...
it('stores paddle purchase', function () {
    ...
    // Arrange
    $course = Course::factory()->create(['paddle_product_id' => 'pro_01hjxx11s2hnq8py4d2a5pmr6m']);
...
it('sends out purchase email', function () {
    // Arrange
    Mail::fake();
    Course::factory()->create(['paddle_product_id' => 'pro_01hjxx11s2hnq8py4d2a5pmr6m']);
